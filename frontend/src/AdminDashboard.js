          ...
          <div className="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
            ...
            <div className="bg-slate-50 p-6 flex justify-center border-t border-slate-100">
              <button 
                ...
                disabled={loading}
                className="group relative inline-flex items-center justify-center px-10 py-4 font-bold text-white transition-all duration-300 bg-slate-800 rounded-xl hover:bg-slate-900 focus:outline-none focus:ring-4 focus:ring-slate-300 shadow-lg shadow-slate-900/20 w-full md:w-auto"
              >
