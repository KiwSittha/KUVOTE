              ...
              {announcements.map((a) => (
                <div key={a._id} className="border border-slate-200 rounded-xl p-4">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    ...
                    {!a.isActive && (
                      <span className="text-xs px-2 py-1 rounded-full border border-slate-200 bg-slate-100 text-slate-600 font-semibold">
                        ปิดแล้ว
                      </span>
                    )}
                  </div>
                  ...
                  {a.isActive && (
                    <button
                      ...
                      className="mt-3 px-3 py-1.5 rounded-lg text-sm bg-red-50 text-red-600 border border-red-200 hover:bg-red-100"
                    >
                      ปิดประกาศ
                    </button>
                  )}
